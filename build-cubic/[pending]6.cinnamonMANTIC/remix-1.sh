...
apt-get install -y casper expect gparted cinnamon-desktop \
 cifs-utils language-pack-en language-pack-gnome-en \
 xfsprogs jfsutils reiserfsprogs shim-signed shim ntfs-3g lvm2 \
 dmraid wamerican fwupdate mokutil ubuntu-settings \
 zram-tools
...
#apt upgrade cinnamon -y
#apt upgrade cinnamon-core -y

##########################################################
#[MAYBE]Task of experiment, from Daniella: uninstall snap, re-install snap (wont this uninstall the Installer?) ---->
# from https://github.com/PJ-Singh-001/Cubic/issues/238#issuecomment-1674169063
...
#EOF
##########################################################
#[UNSELECTED BY DANI] - NOW RE-SELECTED to debug startup:
#[WAIT UNTIL NEXT BUILD BEFORE RE-SELECTING]apt-get install -y plymouth-theme-ubuntucinnamon-spinner
